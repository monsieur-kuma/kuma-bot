...
This Terms of Service Agreement (the "Agreement") is entered into between [vanlinh1602](https://github.com/vanlinh1602) ("Bot Owner") and the user ("User") of the Kuma Bot Discord bot (the "Bot").
